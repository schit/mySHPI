...
pointFontbig = pi3d.Font(config.installpath + "fonts/opensans.ttf", shadow=(0, 0, 0, 255), shadow_radius=4, grid_size=5, codepoints=mytext, add_codepoints=additional)#'0123456789:' +chr(0xE000) + chr(0xE035) + chr(0xE001))
